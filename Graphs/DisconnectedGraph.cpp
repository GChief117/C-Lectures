...
int main() {
    DisconnectedGraph graph(6); // Create a graph with 6 vertices

    // Add edges to the graph to form two disconnected components
    graph.addEdge(0, 1);
    graph.addEdge(1, 2);
    ...
    // Perform DFS and BFS from a vertex in the second component to show it is disconnected
    cout << "DFS (iterative) starting from vertex 3: ";
    graph.DFS_iterative(3); // Perform DFS iteratively starting from vertex 3

    cout << "DFS (recursive) starting from vertex 3: ";
    graph.DFS_recursive_start(3); // Perform DFS recursively starting from vertex 3

    cout << "BFS (iterative) starting from vertex 3: ";
    graph.BFS_iterative(3); // Perform BFS iteratively starting from vertex 3

    cout << "BFS (recursive) starting from vertex 3: ";
    graph.BFS_recursive_start(3); // Perform BFS recursively starting from vertex 3
    ...
    cout << "Graph after removing vertex 1:" << endl;
    printer.printGraph(graph.adj);
